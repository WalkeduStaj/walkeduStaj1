...
//    private BasePage actions;
     ...
     */
    public BasePage(WebDriver driver) {//bu constructor:Sayfa objesinin: driver'ını ayarlar,beklemeyi kurar,JS ve Actions helper'larını başlatır,PageFactory ile elementleri hazırlar.
        this.driver = driver;
        ...
        //   this.actions = new Actions(driver);  // Actions nesnesi başlatılıyor
    ...
    public void moveToElement(WebElement element) {
        // WebDriver ve WebElement'in tanımlandığını varsayalım:
